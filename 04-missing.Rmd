...
plot_missing(overall_status, percent = TRUE)
```
...
-   `fans_label`: The fan base size label for content creators. It ranges from 0 to 5, representing smallest amount of subscriptions to largest amount of subscriptions.
