...
ggplot(data = overall, aes(x = log_date, y=uv_active, fill = fans_level)) +
...
```{r, fig.width=12, fig.height=4}
ggplot(data = overall, aes(x = log_date, y=avs, fill = fans_level)) +
  geom_bar(stat='identity') +
  theme(legend.title = element_blank()) +
  scale_fill_manual(values = c("#002344", "#0055a7", "#0a87ff","#6cb7ff", "#93caff")) +
...
```{r, fig.width=12, fig.height=4}
ggplot(data = overall, aes(x = log_date, y=play, fill = fans_level)) +
  geom_bar(stat='identity') +
  theme(legend.title = element_blank()) +
  scale_fill_manual(values = c("#002344", "#0055a7", "#0a87ff","#6cb7ff", "#93caff")) +
